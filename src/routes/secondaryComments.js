...
/* 댓글 등록 */
router.post('/diary/detail/secondaryComment/:diaryId/:commentId', authMiddleware, async(req, res, next) => {
  try{
...
/* 댓글 수정 */
router.patch('/diary/detail/secondaryComment/:diaryId/:commentId', authMiddleware, async(req, res, next) => {
  try{
